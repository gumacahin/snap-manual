...
size recommended for use in SNAP Hydroponics measures 20"✕16"✕6". Styrofoam boxes
of these sizes are used to transport imported grapes from the United States and
usually come from two manufacturers: Styrotek LLC and Aptco. LLC. They also come
in different designs which means that one has to remember that although their
sizes are similar their upper and lower halves does not fit with the upper and
lower halves of other designs.

There is also a seasonal influx of styrofoam boxes for imported grapes. They are
typically abundant during the months of September to February because these are
...
<Figure
  caption="Compact arrangement of styroboxes." 
  alt="Five styroboxes arranged so that they fit in a 1m⨉1.2m area."
